	...
	public static IArchiveFile getArchiveFile(final File pFile) {
		...
		if (pFile.getName().endsWith(".zip")) {
			try {
				...
				Log.e("daryu-osmdroid","Error opening ZIP file", e);
			}
		}
		...
		if (pFile.getName().endsWith(".sqlite")) {
			try {
				...
				Log.e("daryu-osmdroid","Error opening SQL file", e);
			}
		}
		...
		if (pFile.getName().endsWith(".mbtiles")) {
			try {
				...
				Log.e("daryu-osmdroid","Error opening MBTiles SQLite file", e);
			}
		}
		...
		if (pFile.getName().endsWith(".gemf")) {
			try {
				...
				Log.e("daryu-osmdroid","Error opening GEMF file", e);
			}
		}
