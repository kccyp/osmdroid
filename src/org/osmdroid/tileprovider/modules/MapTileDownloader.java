		...
		public Drawable loadTile(final MapTileRequestState aState) throws CantContinueException {
			...
			try {
				...
				if (mNetworkAvailablityCheck != null
					...
					if (DEBUGMODE) {
						Log.d("daryu-osmdroid","Skipping " + getName() + " due to NetworkAvailabliltyCheck.");
					}
					return null;
				}
				...
				if (DEBUGMODE) {
					Log.e("daryu-osmdroid","Downloading Maptile from url: " + tileURLString);
				}
				...
				if (line.getStatusCode() != 200) {
					Log.w("daryu-osmdroid","Problem downloading MapTile: " + tile + " HTTP response: " + line);
					return null;
				}

				final HttpEntity entity = response.getEntity();
				if (entity == null) {
					Log.w("daryu-osmdroid","No content downloading MapTile: " + tile);
					return null;
				}
				...
				Log.w("daryu-osmdroid","UnknownHostException downloading MapTile: " + tile + " : " + e);
				...
				Log.w("daryu-osmdroid","Tile not found: " + tile + " : " + e);
			} catch (final IOException e) {
				Log.w("daryu-osmdroid","IOException downloading MapTile: " + tile + " : " + e);
			} catch (final Throwable e) {
				Log.e("daryu-osmdroid","Error downloading MapTile: " + tile, e);
			} finally {
