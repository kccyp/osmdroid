...
public abstract class BitmapTileSourceBase implements ITileSource,
		...
		try {
			...
			if (bitmap != null) {
				...
				try {
					...
					Log.e("daryu-osmdroid","Error deleting invalid file: " + aFilePath, e);
				}
			}
		} catch (final OutOfMemoryError e) {
			Log.e("daryu-osmdroid","OutOfMemoryError loading bitmap: " + aFilePath);
			System.gc();
		}
		return null;
	}
	...
	public Drawable getDrawable(final InputStream aFileInputStream) throws LowMemoryException {
		try {
			...
			Log.e("daryu-osmdroid","OutOfMemoryError loading bitmap");
			System.gc();
